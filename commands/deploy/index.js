...
import check_sockets_connect_disconnect_processors from '../../utils/check_sockets_connect_disconnect_processors.js';
...
export default async function deploy(projectName) {
  try {
    ...
    await check_sockets_connect_disconnect_processors(
